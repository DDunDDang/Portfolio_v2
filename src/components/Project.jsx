        ...
        <section className="w-full max-w-4xl px-5 mx-auto">
            <div className="w-screen max-w-4xl">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <picture className="w-full shadow-lg md:w-5/12">
                                <img
                                    src={`./././images/projects/${projects[currentProject].id}.png`}
                                    width="768px"
                                    height="575px"
                                    loading="lazy"
                            ...
                            <div className="flex flex-col w-full space-y-2 md:w-7/12">
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {projects[currentProject].tools.map((tool, id) => (
                                        <span className="px-2 py-1 text-sm border border-gray-500 rounded-lg" key={id}>
                                            {tool}
                                        </span>
                                    ))}
                                </div>
                ...
                <div className="flex justify-center mt-8">
                    <button type="button" onClick={() => window.open("https://github.com/DDunDDang")} className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2" >               
